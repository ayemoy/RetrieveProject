    ...
    def read(self, locs, n_bytes):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                self._open_files[f_name] = open('/home/ayelet431/body/postings_gcp/'+f_name, 'rb')
...
class InvertedIndex:  
    def __init__(self, docs={}):
        ...
        self.doc_to_title = defaultdict(list)
        self.doc_len = defaultdict(list)
        self.tfidf_dominator = defaultdict(list)
